#!/usr/bin/env bash
# Script de sweep d'évaluation DDP pour le noeud 0 (sacrum)
...
MODEL_SWEEP_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/umx_training/seed=40"
EVAL_BASE_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/evaluations/umx_evaluation/seed=40"

echo "============================================================"
echo "  Début du sweep d'évaluation DDP — Noeud 0 (sacrum)"
