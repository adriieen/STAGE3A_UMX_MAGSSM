#!/usr/bin/env bash
# Script de reprise DDP pour le noeud 3 (3)
...
CONFIGS=(
    "eps0.5000_l1_15.0000_l2_4.0000|5|/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/umx_training/seed=38/eps0.5000_l1_15.0000_l2_4.0000|--regularize_window --epsilon1 0.5000 --lambda_coeff_1 15.0000 --lambda_coeff_2 4.0000"
)

echo "============================================================"
echo "  Reprise de l'entraînement DDP — Noeud 3 (3)"
...
for i in "${!CONFIGS[@]}"; do
    ...
    OUTPUT_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/umx_training/seed=38/${RUN_NAME}"
    echo ""
    echo "────────────────────────────────────────────────────"
...
echo "============================================================"
echo "  Reprise terminée sur le noeud 3 !"
echo "============================================================"
