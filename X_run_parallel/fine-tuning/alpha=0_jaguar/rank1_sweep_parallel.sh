#!/usr/bin/env bash
# Script de sweep DDP Fine-Tuning pour le noeud 1 (1)
...
echo "============================================================"
echo "  Début du sweep Fine-Tuning DDP — Noeud 1 (1)"
...
for i in "${!COUPLES_CONFIGS[@]}"; do
    ...
    OUTPUT_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/fine-tuning/alpha=0/separator_frozen/${RUN_NAME}"
...
echo "============================================================"
echo "  Sweep Fine-Tuning DDP terminé sur le noeud 1 !"
echo "============================================================"
