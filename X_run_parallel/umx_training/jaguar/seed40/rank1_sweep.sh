#!/usr/bin/env bash
# Script de sweep DDP pour le noeud 1 (1)
...
WINDOW_CONFIGS=(
    "0.2      2.1694   1"
    "0.0500   4.0000   0.7382"
    "0.0530   0.4980   0.4365"
    "0.1580   0.1796    0.2572"
    "0.1055   0.1000   0.1291"
)

echo "============================================================"
echo "  Début du sweep multi-machines — Noeud 1 (1)"
...
for i in "${!WINDOW_CONFIGS[@]}"; do
    ...
    OUTPUT_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/umx_training/seed=40/${RUN_NAME}"
    echo ""
    echo "────────────────────────────────────────────────────"
...
echo "============================================================"
echo "  Sweep terminé sur le noeud 1 !"
echo "============================================================"
