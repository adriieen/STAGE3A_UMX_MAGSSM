...
OUTPUT_BASE="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/trainable_spectograms/14.7kHz/Tests_post_soutenance/complex_specto/[small_lr]non_progressive_342bins_alpha0_structured_init"
TARGET="vocals"
EPOCHS=400
EPOCHS_RESUME=40    # Nombre d'époques supplémentaires à effectuer en cas de reprise
BATCH_SIZE=8
NB_WORKERS=5
SEQ_DUR=4
CHUNK_DUR=1
