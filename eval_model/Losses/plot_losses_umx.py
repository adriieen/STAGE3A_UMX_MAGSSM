...
plot_lambdas_im = False

dic = {
    "[UMX]341bins, hop = 0.1*nfft]" : "/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/post_soutenance/umx_training/[28-07]seed=42/eps0.5000_l1_4.7027_l2_4.0000/vocals.json"
}
...
for method, path in dic.items(): 
    ...
    os.makedirs('/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/fig/POST_SOUTENANCE/UMX', exist_ok=True)
    plt.savefig(f'/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/fig/POST_SOUTENANCE/UMX/{method}.png')
