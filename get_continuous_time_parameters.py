...
def main():
    ...
    parser.add_argument("path", type=str, nargs="?", 
                        default="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/trainable_spectograms/14.7kHz/regularized_window_double_exp/NFFT=NSTATES=682_alpha0_TEST_NEW_INITv3/eps0.5000_l1_4.7027_l2_4.0000",
