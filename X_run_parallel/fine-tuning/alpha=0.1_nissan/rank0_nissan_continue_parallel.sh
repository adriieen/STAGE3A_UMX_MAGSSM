#!/usr/bin/env bash
# Script de continuation DDP Fine-Tuning pour le noeud 0 (nissan)
...
echo "============================================================"
echo "  Reprise du sweep Fine-Tuning DDP — Noeud 0 (nissan)"
...
echo "============================================================"
echo "  Continuation Fine-Tuning DDP terminée sur le noeud 0 !"
echo "============================================================"
