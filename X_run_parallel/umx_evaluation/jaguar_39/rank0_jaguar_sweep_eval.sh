#!/usr/bin/env bash
# Script de sweep d'évaluation DDP pour le noeud 0 (jaguar)
...
MODEL_SWEEP_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/outputs/umx_training/seed=39"
EVAL_BASE_DIR="/users/eleves-a/2023/adrien.dubois/stage/STAGE3A_UMX_MAGSSM/evaluations/umx_evaluation/seed=39"

echo "============================================================"
echo "  Début du sweep d'évaluation DDP — Noeud 0 (jaguar)"
